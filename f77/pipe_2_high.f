...
c           -> I've gotten data as far as 12.051, but 12.0515 gives jibberish
...
cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
      ...
      parameter (order = 1, m = 21, n = 3*m, iterate = 50)
...
c That huge value for v is for 200,000 intervals, inf=11.4
